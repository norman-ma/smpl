...
public class Environment<T extends SMPLValue<?>> {
    ...
    public void put(String id, T value) {
        if(search(id)==null){
            ...
            search(id).dictionary.put(id, value);
        }
    }
    
    /**
     * Searches for the nearest scope containing the given
     * identifier
     *
     * @param id the name to be searched for
     * 
     * @return null if id is not found
     * @return Environment in which id is found
     */
    private Environment<T> search(String id){
